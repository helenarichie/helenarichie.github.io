...
This model accounts for how dust density changes due to the processes of thermal sputtering and gas-phase metal accretion and are modeled by the following equations:  
