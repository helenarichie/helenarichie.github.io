...
I'm using Cholla to simulate a dusty cloud in a wind tunnel to study how dust survives as the cloud is disrupted by the wind. The details of that work will come later, after we refine our simulation setup