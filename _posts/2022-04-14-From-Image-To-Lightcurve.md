...
There are details aside from the ones that I've pointed out that I could pore over, and there are definitely improvements that I'd like to make to this short visualization, but I already turned in my assignment, so I'm just gonna leave it here as is :-) Anyone looking to use this animation should feel free to do so, as long as they're sure to credit myself and the STEPUP team! The (very clunky and disorganized) code that I used to create these figures can be found in [this GitHub repo](https://github.com/helenarichie/photometry-visualization). I'm happy to share our data on WASP-52 as well, so if you want to play around with it send me an email!