...
This model accounts for how dust density changes due to the processes of thermal sputtering and gas-phase metal accretion and are modeled by the following equations: \( \frac{d\rho_{i,\text{dust}}}{dt} = \Bigg(1-\frac{\rho_{i,\text{dust}}}{\rho_{i,\text{metal}}}\Bigg)\Bigg(\frac{\rho_{i,\text{dust}}}{\tau_g}\Bigg) \)
and 
\(  \frac{d\rho_{i,\text{dust}}}{dt}
\)
