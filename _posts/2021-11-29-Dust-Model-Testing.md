...
# Testing
To test this dust model, I am comparing the known analytic solutions of the differential equations that we're using to mdoel dust with their numerical solutions (generated by the forward-Euler method). 
